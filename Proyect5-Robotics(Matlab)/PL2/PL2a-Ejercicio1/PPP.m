% Script para robot PPP (Prismática-Prismática-Prismática)
...
ylabel('Y (mm)')
zlabel('Z (mm)')
title('Robot PPP - Cinemática Directa DH')
...
q1 = 200; % mm (Prismática)
q2 = 150; % mm (Prismática)
q3 = 100; % mm (Prismática)

% Dibujar sistema de coordenadas base
dibujarSC(eye(4), '0', 80, 2)

% Articulación 1: P (theta=0°, d=q1, a=a, alpha=90°)
T01 = rotaZ(-90) * tras(0,0,q1+a) * tras(0,0,0) * rotaX(90);
dibujarSC(T01, '1', 80, 2)

% Articulación 2: P (theta=0°, d=q2, a=b, alpha=90°)
T12 = rotaZ(-90) * tras(0,0,q2+d) * tras(0,0,0) * rotaX(90);
T02 = T01 * T12;
dibujarSC(T02, '2', 80, 2)

% Articulación 3: P (theta=0°, d=q3, a=c, alpha=0°)
T23 = rotaZ(-90) * tras(0,0,q3+c) * tras(c,0,0) * rotaX(0);
T03 = T02 * T23;
