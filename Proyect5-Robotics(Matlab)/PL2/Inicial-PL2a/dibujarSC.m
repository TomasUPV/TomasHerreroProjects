...
textoZ_H = text(ejes(1,4)-5,ejes(2,4)-5,ejes(3,4)-5,texto);
texto=sprintf('X_%s',etiqueta);
textoX_H = text(ejes(1,2)-5,ejes(2,2)-5,ejes(3,2)-5,texto);
texto=sprintf('Y_%s',etiqueta);
textoY_H = text(ejes(1,3)-5,ejes(2,3)-5,ejes(3,3)-5,texto);