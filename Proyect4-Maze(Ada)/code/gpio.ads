...
MI, MD: boolean;
   ...
   --Display 7S
   type D_type is (off, D1, D7, D0, D3, D2, D4, D9, D5, D11, D6, D8);
   for D_type use (
                   off=>2#0000000#,
                   D1=>2#0000110#,
                   D7=>2#0000111#,
   ...
   for Disp use record
      ...
      Cat at 0 range 11..11; --selección del display (drch o izq)
   end record;
   ...
   -- EJERCICIO 2 SESIÓN 3: Objetos protegidos para el Display 7S
   ...
   -- EJERCICIO 2 SESIÓN 3: Procedimientos de movimiento
   procedure Avanza;
   procedure Para;
   procedure GiroIzq;
   procedure GiroDrcha;

   -- EJERCICIO 2 SESIÓN 3: Procedimiento para mostrar números en el display
   procedure MostrarNumero (numero: Integer);

   -- TAREAS
   task Sensorizacion with CPU => 1;
   task PWM with CPU => 0;  -- EJERCICIO 1 SESIÓN 3
   task Cuenta with CPU => 1;  -- EJERCICIO 3 SESIÓN 3
